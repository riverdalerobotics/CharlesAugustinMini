...
public class OperatorInput {
    ...
    public boolean getXPistOn(){
        return armController.getXButton();
    }
    public boolean getYPistOff(){
    ...
    public boolean getBackReleasedMovement() {
        return movementController.getBackButtonReleased();
    }

    public boolean configureButtonBindings() {
        return movementController.getStartButtonPressed();
    }
    //Used in swerveChassisDefaultCommand 
    public boolean setWheelsZero(){
